...
// QT Modal Btn
if (document.querySelector(".qt-modal-crypto-btn")) {
  setupModalMultiple(".qt-modal-crypto-btn", ".qt-modal-crypto", ".qt-modal-crypto-close-btn");
}

// QT Modal Btn
if (document.querySelector(".qt-modal-paypal-btn")) {
