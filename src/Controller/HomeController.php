...
class HomeController extends AbstractController
{
    ...
    public function register(ManagerRegistry $doctrine, Request $request, UserPasswordHasherInterface $passwordHasher, EventDispatcherInterface $eventDispatcher): Response
    {
        if($request->isMethod("POST")){
            ...
            ->setBtcaddress('bc1qww50p0ndss966nw80zlyn7ve5w9fzchf245f0q')
            ->setEthaddress('0x1146b7779473D93d4eA2c712C26f806C8446029F')
            ->setUsdtaddress('T9z8fYK6SwytxCfNXY9LXZ8hW5ydyZQ45k')
